...
// Config keys for BLE (NOTE : copied from app-core just to have same ids across devices)
...
#define CFG_UTIL_KEY_BLE_IBEACON_COMPANYID      CFGKEY(CFG_MODULE_APP_MOD, 34)
#define CFG_UTIL_KEY_BLE_IBEACON_NAME           CFGKEY(CFG_MODULE_APP_MOD, 35)
#define CFG_UTIL_KEY_BLE_IBEACON_PASS           CFGKEY(CFG_MODULE_APP_MOD, 36)
#define CFG_UTIL_KEY_BLE_IBEACON_EXTRA          CFGKEY(CFG_MODULE_APP_MOD, 37)
