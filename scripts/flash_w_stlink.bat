...
openocd -f %OPENOCD%/scripts/interface/stlink-v2.cfg -f %OPENOCD%/scripts/target/nrf51.cfg -c "init; halt; nrf51 mass_erase; program ./hexs/softdevice.hex verify; program ./%1.hex verify; flash fillw 0x0003A800 0x60671519 1; flash fillh 0x0003A804 0x%2 1;flash fillh 0x0003A806 0x%3 1; reset;shutdown"
